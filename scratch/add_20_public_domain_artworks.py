...
new_artworks = [
    ...
    },
    {
        ...
        "location": "Uffizi Gallery, Florence, Italy",
        "image_url": "https://upload.wikimedia.org/wikipedia/commons/4/4e/Artemisia_Gentileschi_-_Giuditta_decapita_Oloferne_-_Google_Art_Project.jpg",
        "thumbnail_url": "/static/img/artworks/judith-slaying-holofernes.jpg",
        "download_filename": "Gentileschi_Judith_Slaying_Holofernes_UltraHD.jpg",
        "resolution": "4 070 × 5 000 px",
        "file_size": "7.3 MB",
    ...
    },
    {
        ...
        "thumbnail_url": "/static/img/artworks/the-fighting-temeraire.jpg",
        "download_filename": "Turner_The_Fighting_Temeraire_UltraHD.jpg",
        "resolution": "5 000 × 3 730 px",
        "file_size": "6.5 MB",
    ...
    },
    {
        ...
        "image_url": "https://upload.wikimedia.org/wikipedia/commons/a/aa/Claude_Monet_-_Water_Lilies_-_Google_Art_Project_%28462014%29.jpg",
        "thumbnail_url": "/static/img/artworks/water-lilies.jpg",
        "download_filename": "Monet_Water_Lilies_UltraHD.jpg",
        "resolution": "4 700 × 5 000 px",
        "file_size": "7.1 MB",
    ...
    },
    {
        ...
        "image_url": "https://upload.wikimedia.org/wikipedia/commons/1/15/Pierre-Auguste_Renoir_-_Le_D%C3%A9jeuner_des_canotiers.jpg",
        "thumbnail_url": "/static/img/artworks/luncheon-of-the-boating-party.jpg",
        "download_filename": "Renoir_Luncheon_of_the_Boating_Party_UltraHD.jpg",
        "resolution": "5 000 × 3 760 px",
        "file_size": "8.3 MB",
    ...
    },
    {
        ...
        "location": "National Gallery, London, United Kingdom",
        "image_url": "https://upload.wikimedia.org/wikipedia/commons/2/25/John_Constable_-_The_Hay_Wain_%281821%29.jpg",
        "thumbnail_url": "/static/img/artworks/the-hay-wain.jpg",
        "download_filename": "Constable_The_Hay_Wain_UltraHD.jpg",
        "resolution": "5 000 × 3 510 px",
        "file_size": "7.6 MB",
    ...
    },
    {
        ...
        "thumbnail_url": "/static/img/artworks/whistlers-mother.jpg",
        "download_filename": "Whistler_Arrangement_In_Grey_And_Black_UltraHD.jpg",
        "resolution": "5 000 × 4 450 px",
        "file_size": "6.8 MB",
    ...
    },
    {
        ...
        "thumbnail_url": "/static/img/artworks/the-card-players.jpg",
        "download_filename": "Cezanne_The_Card_Players_UltraHD.jpg",
        "resolution": "5 000 × 4 100 px",
        "file_size": "7.9 MB",
    ...
    },
    {
        ...
        "location": "National Gallery, London, United Kingdom",
        "image_url": "https://upload.wikimedia.org/wikipedia/commons/b/b1/Titian_Bacchus_and_Ariadne.jpg",
        "thumbnail_url": "/static/img/artworks/bacchus-and-ariadne.jpg",
        "download_filename": "Titian_Bacchus_and_Ariadne_UltraHD.jpg",
        "resolution": "5 000 × 4 620 px",
        "file_size": "8.9 MB",
    ...
    },
    {
        ...
        "image_url": "https://upload.wikimedia.org/wikipedia/commons/4/4b/%C3%9Altima_Cena_-_Da_Vinci_5.jpg",
        "thumbnail_url": "/static/img/artworks/the-last-supper.jpg",
        "download_filename": "DaVinci_The_Last_Supper_UltraHD.jpg",
        "resolution": "5 000 × 2 610 px",
        "file_size": "9.1 MB",
    ...
    },
    {
        ...
        "image_url": "https://upload.wikimedia.org/wikipedia/commons/f/fe/La_Boh%C3%A9mienne_endormie.jpg",
        "thumbnail_url": "/static/img/artworks/the-sleeping-gypsy.jpg",
        "download_filename": "Rousseau_The_Sleeping_Gypsy_UltraHD.jpg",
        "resolution": "5 000 × 3 230 px",
        "file_size": "6.6 MB",
        "description": "A wandering musician sleeps soundly in a moonlit desert holding a mandolin and water jug while a curious lion sniffs her gently without harm.",
        "analysis": "A haunting dreamscape of Naïve Art and Proto-Surrealism, defined by sharp silhouettes, enchanted moonlight, and poetic tranquility.",
        "featured": False,
        "instagram_post_caption": "Henri Rousseau's poetic dream under the desert moon: The Sleeping Gypsy.",
        "instagram_tag": "@classicartarchive",
        "license": "Public Domain (CC0 / PDM 1.0)"
    }
]
...
def get_wikimedia_highres_url(image_url: str) -> str:
    """Extract File name and query API for 4096px+ render or original."""
...
print(f"Downloading and processing {len(new_artworks)} public domain artworks...")
...
for i, artwork in enumerate(new_artworks, 1):
    ...
    print(f"\n[{i}/20] Processing {artwork['title']} ({slug})...", flush=True)
...
# Now load existing artworks and append new artworks
with open(DATA_FILE, "r", encoding="utf-8") as f:
    existing_artworks = json.load(f)

# Ensure no duplicate slugs
existing_slugs = {a["slug"] for a in existing_artworks}
to_add = [a for a in new_artworks if a["slug"] not in existing_slugs]
